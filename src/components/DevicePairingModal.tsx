...
function formatExpiry(expiresAt: string | number | Date): string {
...
const DevicePairingModal = ({ onClose }: DevicePairingModalProps) => {
        ...
        {code && (
          <>
            ...
            <p className="mt-3 text-xs text-faint">
              {expiresAt && formatExpiry(expiresAt)} · single use
            </p>
          </>
        )}
      </div>
