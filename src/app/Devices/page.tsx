            ...
            <Table>
              ...
              <tbody>
                {devices.map((device) => {
                  ...
                  // Only present when isAdmin, via getAllDevicesWithOwners()
                  const owner = device as typeof device & { ownerName?: string | null; ownerEmail?: string };

                  return (
                    <tr
                      key={device.id}
                      className={rowClasses({ dimmed: Boolean(device.revoked) })}
                    >
                      {isAdmin && (
                        <Td>
                      ...
                      <Td>
                        <DotBadge tone={status.tone} live={status.tone === "success"}>
                          {status.label}
                        </DotBadge>
                      </Td>
                      <Td align="right">
                        {device.revoked ? (
                          ...
                          <form action={revokeDeviceAction}>
                            ...
                            <SubmitButton tone="danger" pendingLabel="Revoking…">
                              Revoke
                            </SubmitButton>
                          </form>
                        )}
